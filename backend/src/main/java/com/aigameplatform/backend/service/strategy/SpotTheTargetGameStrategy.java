...
public class SpotTheTargetGameStrategy extends GameContentStrategy {
    ...
    public List<QuestionGame> parseToQuestions(String rawJson) {
        // TODO: parse rawJson thành các câu hỏi SPOT_THE_TARGET theo JSON DSL Schema v1.0.0.
        throw new UnsupportedOperationException("Chưa cài đặt parseToQuestions cho SPOT_THE_TARGET");
    }
