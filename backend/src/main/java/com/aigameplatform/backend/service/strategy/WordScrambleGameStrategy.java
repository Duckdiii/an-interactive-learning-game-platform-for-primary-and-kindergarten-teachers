...
public class WordScrambleGameStrategy extends GameContentStrategy {
    ...
    public List<QuestionGame> parseToQuestions(String rawJson) {
        // TODO: parse rawJson thành các câu hỏi WORD_SCRAMBLE theo JSON DSL Schema v1.0.0.
        throw new UnsupportedOperationException("Chưa cài đặt parseToQuestions cho WORD_SCRAMBLE");
    }
